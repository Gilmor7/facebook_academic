...
int main()
{
...

    {
        ...
        system.addUser(*f1);   // should give error msg and not add

        system.addPage(*p1);
        system.addPage(*p2);

        system.addPage(*p2);  // should give error msg

        system.connectUsers(*f1, *f2);
        system.connectUsers(*f1, *f2);  // should give msg users are connected

        system.removeUsersConnection(*f1, *f2);
        system.removeUsersConnection(*f1, *f2); // should give msg users not connected
